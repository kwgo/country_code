...
public class FallWidgetRatioProvider extends AppWidgetProvider {
    @Override
    ...
    public void onUpdate(Context context, AppWidgetManager appWidgetManager, int[] appWidgetIds) {
        RemoteViews views = new RemoteViews(context.getPackageName(), R.layout.fall_widget_ratio);
        //ComponentName componentName = new ComponentName(context, MainWidget.class);
        //int[] widgetIds = appWidgetManager.getAppWidgetIds(componentName);
        for (int appWidgetId : appWidgetIds) {
            Intent intent = new Intent(context, FallWidgetRatioProvider.class);
