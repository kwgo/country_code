...
public class FallCountryAdapter extends RecyclerView.Adapter<FallCountryAdapter.ViewHolder> {
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        ViewHolder(View itemView) {
            ...
            this.topImage.setOnClickListener((v) -> ((FallCountryActivity) context).onSelect(itemView, item));
            this.bottomImage.setOnClickListener((v) -> ((FallCountryActivity) context).onSelect(itemView, item));
            this.topText.setOnClickListener((v) -> ((FallCountryActivity) context).onSelect(itemView, item));
            this.bottomText.setOnClickListener((v) -> ((FallCountryActivity) context).onSelect(itemView, item));
        }
    }
}