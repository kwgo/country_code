...
public abstract class FallCountryHelper {
    ...
    public static boolean isSortable(int sortIndex, boolean isPortrait) {
        if (isPortrait) {
            if (sortIndex == FallCountryHelper.SORT_OFFICIAL || sortIndex == FallCountryHelper.SORT_ALPHA_3 || sortIndex == FallCountryHelper.SORT_NUMERIC || sortIndex == FallCountryHelper.SORT_SYMBOL || sortIndex == FallCountryHelper.SORT_POPULATION) {
                return false;
            }
        } else {
            if (sortIndex == FallCountryHelper.SORT_COUNTRY) {
                return false;
            }
        }
        return true;
